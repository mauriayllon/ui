...
public class DeleteTodoLyTest {
    ...
    public void loginTodoLy() throws InterruptedException {
        ...
        // click delete button
        driver.findElement(By.xpath("//ul[@id='projectContextMenu']//a[@href='#delete']")).click();
        ...
        Assert.assertFalse("No borro el projecto",myPrject.equals(actualResult));
